...
const photoFormDiv = document.querySelector(".photo-form-container");
  ...
  const handlePhotoSubmit=(e)=>{e.preventDefault();
    ...
    const newPhotoLi=document.createElement("li");newPhotoLi.appendChild(newImg);
    const dogPhotosList=document.querySelector(".dog-photos");dogPhotosList.appendChild(newPhotoLi);};
